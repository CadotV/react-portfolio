...
// TODO: export all as IconData from this file
...
export const electron = {
  ...
  icon: <IoLogoElectron />,
  color: "#c9eff7",
  link: "https://www.electronjs.org/fr/",
};
export const nodejs = {
  text: "Nodejs",
  icon: <FaNodeJs />,
...
export const glsl = {
  ...
  icon: <BsGpuCard />,
  color: "black",
  link: "https://webglfundamentals.org/webgl/lessons/fr/webgl-shaders-and-glsl.html",
};
